...
$(document).ready(function(){
    ...
    $('#filer_input2').filer({
        limit: 3,
        maxSize: 3,
        extensions: ['jpg', 'jpeg', 'png', 'docx', 'xlsx', 'pdf'],
        changeInput: true,
        showThumbs: true,
        addMore: true
    });
    ...
    $("#filer_input1").filer({
        ...
        captions: {
            ...
            errors: {
                filesLimit: "The file type you have chosen is not allowed.", //"Only {{fi-limit}} files are allowed to be uploaded.",
                filesType: "The file type you have chosen is not allowed.",
