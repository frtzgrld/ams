...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <!-- <hr> -->
            <form id="ris_header" action="<?php echo base_url(); ?>file/par/par_header_save" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3" for="createdby" align="left">
                        <input type="text" class="form-control" name="par_no" id="par_no" value="">
                    </div>
                    <!-- <div class="col-md-9 col-md-offset-9 error-message"></div> -->
                </div>
