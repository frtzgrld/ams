...
<div class="col-sm-12">
    <div class="card-box">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="m-b-30">
                	<a href="ics/ics_new" class="btn btn-primary waves-effect waves-light"><span>Create Inventory Custodian Slip</span></a>
                </div>
            </div>
        </div>  
...
$(document).ready(function () {
                ...
                $('#datatable_items').dataTable({
                    ...
                    "serverSide": true,
                    "ajax": base_url + 'file/ics/datatable_ics_list',
                    "order": [[ 0, "asc" ]],
                    "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) 
                    {
                        var buttons = "<a class='btn btn-primary btn-xs btn-icon icon-left' href='" + base_url + 'file/ics/ics_items/' + aData[0] + "'><i class='zmdi zmdi-info-outline'></i> View</a>";
