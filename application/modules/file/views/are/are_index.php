...
<div class="col-sm-12">
    <div class="card-box">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="m-b-30">
                	<a href="are/are_new" class="btn btn-primary waves-effect waves-light"><span>Create Acknowledgement Receipt for Equipment</span></a>
                </div>
            </div>
        </div>  
...
$(document).ready(function () {
                ...
                $('#datatable_items').dataTable({
                    ...
                    "serverSide": true,
                    "ajax": base_url + 'file/are/datatable_are_list',
                    "order": [[ 0, "asc" ]],
                    "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) 
                    {
                        var buttons = "<a class='btn btn-primary btn-xs btn-icon icon-left' href='" + base_url + 'file/are/are_items/' + aData[0] + "'><i class='zmdi zmdi-info-outline'></i> View</a>";
