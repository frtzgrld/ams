...
<?php
	foreach ($supply as $row): ?>
		...
		<script type="text/javascript">
			var item_id = '<?php echo $row['ITEMID']; ?>';
		</script>
			        ...
			        <div>
			            ...
			            <div class="wid-u-info">
			                <h3 class="m-t-0 m-b-5">
			                	<?php echo $row['ITEMS']; ?>
			                	<br><small><!-- <?php echo '<b>'.$row['QTYONHAND'].'</b> '.(plural($row['UNIT'])); ?> --></small>
			                </h3>
			                <h5 class="m-t-0"><?php echo $row['QTYSTATUS']; ?></h5>
			            </div>
			        </div>
			    </div>
			</div>
			...
			<div class="col-md-2">
				<div class="card-box widget-user">
                    <div class="text-center">
                        ...
                        <h2 class="text-custom" data-plugin="counterup"><?php echo number_format($row['QTYONHAND']); ?></h2>
	...
	endforeach; ?>
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default bx-shadow-none">
                ...
                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false">
                    <div class="panel-body">
                        <table id="datatable_purchase_history" class="table table-striped table-hover table-bordered dt-responsive nowrap">
                            <thead>
                                <tr class="center">
                                    <th width="25%">Date Purchased</th>
                                    <th width="15%">Quanity Purchased</th>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#datatable_purchase_history').dataTable({
                    "processing": true,
                    "language": {
                        "processing": '<img src="'+base_url+'assets/images/loaders/search_loader_1.gif" width="120px"/> Loading. Waiting for response...'
                    },
                    "serverSide": true,
                    "ajax": base_url + 'inventory/supplies/datatable_supply_history/'+item_id,
                    "order": [[ 0, "desc" ]],
                    "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) 
                    {
                        var buttons = "<a class='btn btn-info btn-xs btn-icon icon-left' href='" + base_url + 'inventory/supplies/acquisitions/' + aData[4] + "'><i class='ti ti-info-alt'></i> View Detail</a> " + "<button class='btn btn-success waves-effect waves-light btn-xs' onclick='toggle_office(" + aData[4] + ")'><i class='ti ti-pencil-alt'></i> Edit</button>",
                        	buttons = null;
                ...
                $('#datatable_distrib_history').dataTable({
                    ...
                    "serverSide": true,
                    "ajax": base_url + 'distribution/datatable_distrib_history/'+item_id,
                    "order": [[ 0, "desc" ]],
                    "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) 
                    {
